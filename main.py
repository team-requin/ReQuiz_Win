...
class Main_Window(QWidget):
    ...
    def initUI_list(self):
        ...
        plus_btn.setStyleSheet('QPushButton{border: 0;'
                               'display: block;'
                               'font-size: 15px;'
                               'font-weight: bold;'
                               'border-radius: 5px;'
        ...
        modify_btn.setStyleSheet("QPushButton:hover{background-color : #8DEE88; border_radius: 10px; color: #168235}"
        ...
        modify_btn2_2 = QPushButton('수정', self)
        modify_btn2_2.resize(120, 70)
        modify_btn2_2.setStyleSheet("QPushButton{background-color: #b1ffa7; border-radius: 5px;}"
                                    "QPushButton:hover{background-color: #A4EEA3; border-radius: 5px;}")
        modify_btn2_2.move(1100, 230)
        modify_btn2_2.show()

        modify_btn2_3 = QPushButton('수정', self)
        modify_btn2_3.resize(120, 70)
        modify_btn2_3.setStyleSheet("QPushButton{background-color: #b1ffa7; border-radius: 5px;}"
                                    "QPushButton:hover{background-color: #A4EEA3; border-radius: 5px;}")
        modify_btn2_3.move(1100, 310)
        modify_btn2_3.show()

        modify_btn2_4 = QPushButton('수정', self)
        modify_btn2_4.resize(120, 70)
        modify_btn2_4.setStyleSheet("QPushButton{background-color: #b1ffa7; border-radius: 5px;}"
                                    "QPushButton:hover{background-color: #A4EEA3; border-radius: 5px;}")
    ...
    def eventFilter(self, object, event):
        ...
        self.blank_label = QLabel('First Library', self)
        self.blank_label.resize(600, 72)
        self.blank_label.setStyleSheet("QLabel{background-color: white; border-radius: 10px; font: 30px Bahnschrift;}"
                                        "QLabel:hover{background-color: #cccccc; border-radius: 10px; font: 30px Bahnschrift;}")
        self.blank_label.move(450, 200)
